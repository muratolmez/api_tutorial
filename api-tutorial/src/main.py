...
class User(messages.Message):
    ...
    gender = messages.StringField(6,required = True)
    phone = messages.IntegerField(7,required = True)
    birthday = messages.StringField(8,required = True)
...
# [START api_server]
api = endpoints.api_server([GreetingApi,User_Api, AuthedGreetingApi])
# [END api_server]